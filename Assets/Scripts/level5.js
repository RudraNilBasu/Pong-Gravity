...
function Update()
{
	if(justOnce ==0)
	{
		...
		theWall.GetComponent(wallMovement).level=5;
	...
	if(score> PlayerPrefs.GetFloat("level5"))
	{
		PlayerPrefs.SetFloat("level5",score);
	}
	//Debug.Log(PlayerPrefs.GetFloat("level1"));
	highScoreDisplay.text = "PERSONAL BEST  "+PlayerPrefs.GetFloat("level5");
}